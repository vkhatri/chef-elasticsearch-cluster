...
[![Cookbook](http://img.shields.io/badge/cookbook-v0.5.2-green.svg)](https://github.com/vkhatri/chef-elasticsearch-cluster) [![Build Status](https://travis-ci.org/vkhatri/chef-elasticsearch-cluster.svg?branch=master)](https://travis-ci.org/vkhatri/chef-elasticsearch-cluster)
...
``` ruby
cookbook 'elasticsearch-cluster', '~> 0.5.2'
```
